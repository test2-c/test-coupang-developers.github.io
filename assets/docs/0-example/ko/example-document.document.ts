...
export const exampleDocument = {
    ...
    documentInfo: {
      category: `example-api`,   // input category ex) exchange-service-api
      id: `example-one`,           // use **dash** and *english*  ex) coupang-confirm-request-creation
    ...
    apiInfo: {
      state: `stable`,      // draft, candidate, release, unstable, stable, deprecated
...
<img src="/assets/docs/0-example/ko/img/black-wallpaper-hd.jpg">
`,
      _relation: ``,
      _referenceInfo: ``,
      _warning: `it will be deprecated`,
    },
    parameters: {
    ...
    errorSpec: [
      {
        ...
        _relation: ``,
        _referenceInfo: `it' have to blablabla`,
        _warning: ``
      },
      {
        status: 400,
