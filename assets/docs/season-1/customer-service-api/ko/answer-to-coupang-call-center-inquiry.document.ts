export const customerServiceCenterEnquiryResponseDocument = {
  ...
  apiInfo: {
    ...
    HMACPath: `/v2/providers/wing_api/apis/internal-api/v1/customer-service/coupang/replies/{counselingId}`,
    ...
    pathSegmentParameters: [
      {
        ...
        _relation: ``,
        _referenceInfo: `이 파라미터는 셀러가 어느 질문을 대답해야할지를 가르킴니다.<br>우선  /v2/providers/wing_api/apis/internal-api/v1/customer-service/coupang/inquiries API 를 사용하여 이 값을 받으십시오.`,
        _warning: ``,
      }
    ],
