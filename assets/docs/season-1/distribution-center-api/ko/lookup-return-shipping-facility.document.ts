export const lookupReturnShippingFacilityDocument = {
  ...
  apiInfo: {
    ...
    HMACPath: `/v2/providers/wing_api/apis/internal-api/v2/return/shipping-places`,
  ...
  sample: {
    endpoint: `https://api-gateway.coupang.com/v2/providers/wing_api/apis/internal-api/v2/return/shipping-places?vendorId=A00012697&pageNum=1&pageSize=50`,
    code: [
      {
        language: `http`,
        codeblock: {
