export const modifyReturnShippingFacilityDocument = {
  ...
  apiInfo: {
    ...
    HMACPath: `/v2/providers/wing_api/apis/internal-api/v1/return/shipping-places/{returnCenterCode}`,
  ...
  sample: {
    endpoint: `https://api-gateway.coupang.com/v2/providers/wing_api/apis/internal-api/v1/return/shipping-places/{returnCenterCode}`,
    code: [
      {
        language: `http`,
        codeblock: {
