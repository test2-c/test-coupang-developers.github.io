export const createReturnShippingFacilityDocument = {
  ...
  apiInfo: {
    ...
    HMACPath: `/v2/providers/wing_api/apis/internal-api/v1/return/shipping-place-creations`,
  ...
  sample: {
    endpoint: `https://api-gateway.coupang.com/v2/providers/wing_api/apis/internal-api/v1/return/shipping-place-creations`,
    code: [
      {
        language: `http`,
        codeblock: {
