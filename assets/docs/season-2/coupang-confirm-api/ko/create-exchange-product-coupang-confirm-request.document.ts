export const createExchangeProductCoupangConfirmRequestDocument = {
  ...
  apiMigrationInfo: {
    ...
    nextVersions: [
      {
        apiName: `매출내역 조회`,
        path: `/v2/providers/openapi/apis/api/v4/vendors/{vendorId}/exchangeRequests/{exchangeId}/coupangConfirmations`,
        _description: ``,
        _relation: ``,
        _referenceInfo: ``,
        _warning: ``
  ...
  apiInfo: {
    ...
    httpMethod: `POST`,
    path: `/v2/providers/openapi/apis/api/v4/vendors/{vendorId}/exchangeRequests/{exchangeId}/coupangConfirmations`,
    HMACPath: `/v2/providers/openapi/apis/api/v4/vendors/{vendorId}/exchangeRequests/{exchangeId}/coupangConfirmations`,
  ...
  sample: {
    endpoint: `https://api-gateway.coupang.com/v2/providers/openapi/apis/api/v4/vendors/{vendorId}/exchangeRequests/{exchangeId}/coupangConfirmations`,
    code: [
      {
        language: `http`,
        codeblock: {
