export const customerServiceCenterEnquiryResponseDocument = {
  ...
  documentInfo: {
    ...
    id: `customer-service-center-enquiry-response`,           // use **dash** and *english*  ex) coupang-confirm-request-creation
    name: `고객센터 문의답변`,       // use display name, i will change 'translation key'
