export const lookupCustomerServiceCenterEnquiryDocument = {
  ...
  documentInfo: {
    ...
    id: `lookup-customer-service-center-enquiry`,           // use **dash** and *english*  ex) coupang-confirm-request-creation
    name: `고객센터 문의조회`,       // use display name, i will change 'translation key'
