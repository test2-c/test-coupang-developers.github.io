export const changePriceBasedOnDiscountRateByProductDocument = {
  ...
  documentInfo: {
    ...
    name: `상품별 할인율 기준가격 변경`,       // use display name, i will change 'translation key'
  ...
  apiInfo: {
    ...
    _description: `옵션 할인율기준가를 변경한다. 이 기능은 업체상품 신청후 승인완료되어 옵션아이디(vendorItemId)가 발급되면 사용할 수 있다.`,
    _relation: ``,
    _referenceInfo: ``,
    _warning: ``,
  },
